...
export const QuoteCalculator: React.FC = () => {
  ...
  const generatePDF = () => {
    ...
    doc.text(`${quotationId} — Date: ${currentDate}`, pageWidth / 2, yPosition, { align: 'center' });
    
    yPosition += 15;

    // Customer Details Section
    if (quote.customerName || quote.customerEmail || quote.customerPhone || quote.customerCompany) {
      doc.setFont('helvetica', 'bold');
      doc.setFontSize(12);
      ...
      if (quote.customerName) {
        doc.text(`Name: ${quote.customerName}`, 25, yPosition);
        yPosition += 5;
      }
      if (quote.customerEmail) {
        doc.text(`Email: ${quote.customerEmail}`, 25, yPosition);
        yPosition += 5;
      }
      if (quote.customerPhone) {
        doc.text(`Phone: ${quote.customerPhone}`, 25, yPosition);
        yPosition += 5;
      }
      if (quote.customerCompany) {
        doc.text(`Company: ${quote.customerCompany}`, 25, yPosition);
        yPosition += 5;
      }
      yPosition += 10;
    }
    ...
    if (quote.includeDesign) {
      ...
      doc.text('Design:', 25, yPosition);
      doc.text(designCost, pageWidth - 25, yPosition, { align: 'right' });
      yPosition += 6;
    }

    if (quote.includeISBN) {
      const isbnCost = `NGN ${calculations.isbnCost.toLocaleString()}`;
      doc.text('ISBN:', 25, yPosition);
      doc.text(isbnCost, pageWidth - 25, yPosition, { align: 'right' });
      yPosition += 6;
    }
    ...
    // Final Quotation in highlighted box
    yPosition += 10;
    doc.setDrawColor(37, 99, 235); // Royal Blue
    doc.setLineWidth(1.5);
    doc.rect(20, yPosition - 8, pageWidth - 40, 20);
    ...
    // Footer with staff details and company info
    yPosition += 40;
    doc.setFont('helvetica', 'normal');
    doc.setFontSize(9);
    
    if (quote.staffName || quote.staffId) {
      const staffInfo = `Generated by: ${quote.staffName}${quote.staffId ? ` (${quote.staffId})` : ''}`;
      doc.text(staffInfo, 20, yPosition);
      yPosition += 5;
    }
    
    doc.text('Contact: +234-XXX-XXXX | info@glitquote.com', 20, yPosition);
    yPosition += 5;
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-[var(--shadow-card)]">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="bookSize" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                  ...
                  <div>
                    <Label htmlFor="coverType" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                  ...
                  <div>
                    <Label htmlFor="pageCount" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                  ...
                  <div>
                    <Label htmlFor="copies" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                ...
                {quote.pageCount > 0 && quote.copies > 0 && (
                  <div className="bg-accent rounded-lg p-3 mt-4">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                      <span className="flex flex-col sm:flex-row items-start sm:items-center gap-2 font-medium">
            ...
            <Card className="shadow-[var(--shadow-card)]">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="paperType" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                      <FileText className="h-4 w-4 text-primary" />
                      Paper Type
                    </Label>
                  ...
                  <div>
                    <Label htmlFor="interiorType" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                ...
                <div>
                  <Label htmlFor="finishing" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
            ...
            <Card className="shadow-[var(--shadow-card)]">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                    <Label htmlFor="includeDesign" className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                    <Label htmlFor="includeISBN" className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                      <Label htmlFor="includeBHR" className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
            ...
            <Card className="shadow-[var(--shadow-card)]">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="customerName" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                  ...
                  <div>
                    <Label htmlFor="customerEmail" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                      Customer Email
                    </Label>
                    <Input
                      id="customerEmail"
                  ...
                  <div>
                    <Label htmlFor="customerPhone" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                      Customer Phone
                    </Label>
                    <Input
                      id="customerPhone"
                  ...
                  <div>
                    <Label htmlFor="customerCompany" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                      Company (Optional)
                    </Label>
                    <Input
                      id="customerCompany"
            ...
            <Card className="shadow-[var(--shadow-card)]">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="staffName" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                  ...
                  <div>
                    <Label htmlFor="staffId" className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-2">
                      Staff ID / Initials
                    </Label>
                    <Input
                      id="staffId"
